...
// Leads & tasks: scoped per-requester inside the controller (EMPLOYEE→own, MANAGER→team).
...
router.get("/team-performance", roleMiddleware(["SUPER_ADMIN", "MANAGER"]), exportController.exportTeamPerformance);
