...
router.post("/",           roleMiddleware(["SUPER_ADMIN", "ADMIN"]), createField);
router.patch("/:id",       roleMiddleware(["SUPER_ADMIN", "ADMIN"]), updateField);
router.delete("/:id",      roleMiddleware(["SUPER_ADMIN", "ADMIN"]), deleteField);
